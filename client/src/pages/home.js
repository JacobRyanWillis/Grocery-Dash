...
const Home = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="md:h-screen grid grid-cols-1 md:grid-cols-2">
        <div className='flex flex-col ml-4 mr-4 md:ml-6 space-y-8 mt-5 md:mt-20'>
          <Logo />
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 md:mr-20 md:pt-10'>
            <div className="relative">
              ...
              <p className="absolute font-gilroy bottom-0 left-0 w-full bg-black bg-opacity-50 text-white text-center p-2 rounded">Austell</p>
            </div>
            <div className="relative">
              <img src={Marietta} alt="Marietta Market" className='w-full h-auto rounded drop-shadow-2xl' />
              <p className="absolute font-gilroy bottom-0 left-0 w-full bg-black bg-opacity-50 text-white text-center p-2 rounded">Marietta</p>
            </div>
            <div className="relative">
          ...
          <div className="flex flex-col items-center mt-4">
            ...
            <svg className="animate-bounce mt-2 w-6 h-6 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
